...
namespace MusicEvents.DataAccess.Migrations
{
    ...
    [Migration("20220310054531_SaleCollectionStore")]
    partial class SaleCollectionStore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicEvents.DataAccess.MusicEventsUserIdentity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MusicEvents.Entities.Complex.SaleInfo", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MusicEvents.DataAccess.MusicEventsUserIdentity", null)
                        .WithMany()
